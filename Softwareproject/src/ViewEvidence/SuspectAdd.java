...
public class SuspectAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setBounds(170, 130, 190, 27);
        ...
        jPanel2.add(jLabel9);
        jLabel9.setBounds(140, 350, 150, 100);
        ...
        jTextField2.setBounds(300, 380, 140, 26);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
          ...
          String s = "Select * from Case2 where Case_Name='"+caseid+"'";
          Statement ss = conn.createStatement();
          ResultSet rss = ss.executeQuery(s);
         ...
         note = jTextArea3.getText();
            ...
            String sql = "Insert into Suspect (CaseID,Name,Contact,Relation,Image,Note,Address) values ('"+id+"','"+name+"','"+contact+"','"+relation+"','"+image+"','"+note+"','"+address+"')";
