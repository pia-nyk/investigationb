...
public class Profile extends javax.swing.JFrame {
  ...
  /**
    ...
    private void initComponents() {
        ...
        jButton19.setText("Update Result");
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jComboBox5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(75, 75, 75)
    ...
    private void jComboBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox5ActionPerformed
        ...
        try{
         conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/InvestigationBureau","root","");
         String s = jComboBox3.getItemAt(jComboBox3.getSelectedIndex());
         
         String sql = "Select * from Case2 natural join Suspect where Case_Name='"+s+"'";
         Statement st = conn.createStatement();
         ResultSet rs = st.executeQuery(sql);
         
         while(rs.next()){
             jComboBox5.addItem(rs.getString(8));
         }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        new ViewEvidence(this.admin_name,this.admin_id,1).setVisible(true);
        this.setVisible(false);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        new ViewSuspect(this.admin_name,this.admin_id,1).setVisible(true);
        this.setVisible(false);
