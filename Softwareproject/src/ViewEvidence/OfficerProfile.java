...
public class OfficerProfile extends javax.swing.JFrame {
    ...
    public OfficerProfile(String name,int id){
        initComponents();
  ...
  /**
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try{
               ...
               String sql = "Select * from Officer where OfficerID=? and Password=md5(?)";
               ...
               if(rs.next()){
                   ...
                   JOptionPane.showMessageDialog(null, "Please recheck Password");
                       ...
                       sql = "Update Officer set Password=md5('"+n_p+"') where OfficerID='"+this.officer_id+"'";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
       new SuspectAdd(this.officer_name,this.officer_id).setVisible(true);
       this.setVisible(false);
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try{
          ...
          // System.out.print(officer_id);
            ...
            String query = "Insert into Case (CaseID,Case_Name,Description,Type,Complainant_Name,Allocated) values ('"+case_id+"','"+case_name+"','"+description+"','"+type+"','"+complainant_name+"','0')";
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        new ViewEvidence(this.officer_name,this.officer_id,2).setVisible(true);
        this.setVisible(false);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        new ViewSuspect(this.officer_name,this.officer_id,2).setVisible(true);
        this.setVisible(false);
